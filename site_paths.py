...
def build_site_env(site: SiteConfig) -> Dict[str, str]:
    ...
    env: Dict[str, str] = {
        **CPU_THREAD_LIMITS,
        ...
        "MOBILE_BOT_UMAP_MODEL_PATH": str(site.mobile_models.bot_umap),
        "MOBILE_BOT_CENTROID_PATH": str(site.mobile_models.bot_centroid),
        "MOBILE_SCALER_PATH": str(site.mobile_models.scaler),
        "DESKTOP_BOT_UMAP_MODEL_PATH": str(site.desktop_models.bot_umap),
        "DESKTOP_BOT_CENTROID_PATH": str(site.desktop_models.bot_centroid),
