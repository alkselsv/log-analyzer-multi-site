...
FEATURES_PATH = os.environ.get(
    ...
    os.environ.get("NORMALIZED_FEATURES_PATH", "mmv_session_features_enhanced_mean_only_normalized.csv"),
)
...
OUTPUT_PATH = os.environ.get(
    ...
    os.environ.get("DESKTOP_PREDICT_RESULTS", "predict_results.csv"),
)
...
def run_order_prediction():
    if not os.path.exists(FEATURES_PATH):
        print(
            ...
            "Убедитесь, что preprocessor_mmv_enhanced_fixed_new.py выполнен успешно."
        )
        sys.exit(1)
